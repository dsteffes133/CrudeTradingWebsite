...
_WPR_KEEP_COLS = [  # shortened example; include full list in production
    ...
    'EIA PADD5 REFINER NET CRUDE INPUT', 'EIA US COM CRUDE IMP EX SPR',
    'EIA PADD1 COM CRUDE IMP EX SPR', 'EIA PADD2 COM CRUDE IMP EX SPR',
    'EIA PADD3 COM CRUDE IMP EX SPR', 'EIA PADD4 COM CRUDE IMP EX SPR',
    'EIA PADD5 COM CRUDE IMP EX SPR'
    # ...
]
...
_WPR_FLOW_COLS  = ['EIA US CRUDE OIL PRODUCTION',
    'EIA US COM CRUDE IMP EX SPR',
    'EIA PADD1 COM CRUDE IMP EX SPR', 
    'EIA PADD2 COM CRUDE IMP EX SPR',
    'EIA PADD3 COM CRUDE IMP EX SPR', 
    'EIA PADD4 COM CRUDE IMP EX SPR',
    'EIA PADD5 COM CRUDE IMP EX SPR',
